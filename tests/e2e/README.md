...
| `s01-happy-lite.sh` | **REMOVED (2026-09-26)** — was the LITE tamper variant (SB-off → PCR 7 drift → refusal → 3 wrong passphrases); absorbed by the `s01c` lifecycle pipeline (`s01-lifecycle-chain.sh`). File and registry row are gone. |
