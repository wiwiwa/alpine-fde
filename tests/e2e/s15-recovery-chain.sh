...
#
# Superseded scenarios (s15, s17) are REMOVED (2026-09-26 removal sweep:
# files AND registry rows gone) — this pipeline is their only home. This
# pipeline is a CHAIN member and
